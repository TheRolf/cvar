...
class TestExcelReader(unittest.TestCase):
    ...
    def setUpClass(self):
        self.data = Data()
        self.data = ExcelReader.read(self.data, Root.path() + '/../resources/test0.xlsm')[0]
    ...
    def test_lengthParameters(self):
        ...
        self.assertEquals(self.data.numberOfTimeIntervals, 24, \
                          "Number of time intervals doesn't match (preferred: 24, actual: " + str(self.data.numberOfTimeIntervals) + ")")
    ...
    def test_1dArrayParameters(self):
        ...
        for t in range(self.data.numberOfTimeIntervals):
